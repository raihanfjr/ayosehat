<body>
    ...
    <div data-aos="fade-up">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8">
                    <form class="search-form" method="get" action="<?= base_url('c_pasien/sdokter') ?>">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 text-center" style="padding-bottom: 15px;">
                    ...
                    <h1 class="text-center" style="background-color: #ffffff;color: rgb(255,255,255);margin-top: 0px;margin-bottom: 0px;"><a class="btn btn-primary text-left" role="button" style="background-color: rgb(234,1,1);" href="' . base_url('c_pasien/jpasien/') . $r->id . '">BUAT JANJI</a></h1>
                </div>
            </div>
        </div>
    </div>');
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#namedr').autocomplete({
                source: "<?php echo site_url('c_pasien/autocomplete'); ?>",

<body>
    ...
    <div data-aos="fade" class="register-photo" style="margin-top: 55px;padding-top: 91px;padding-bottom: 90px;">
        <div class="form-container">
            <div class="image-holder" style="background-image: url(<?= base_url(); ?>assets/img/dokter4.jpg);background-position: center;background-size: cover;"></div>
            <form method="post" action="<?= base_url("c_main/registerd") ?>">
                <h2 class="text-center"><strong>Buat</strong>&nbsp;akun dokter.</h2>
                ...
                <div class="form-group">
                    <label for="hospital">Asal Rumah Sakit</label>
                    <select class="form-control" id="hospital" name="hospital">
                        <option value=1>Rumah Sakit Permata Cibubur</option>
                        <option value=2>Rumah Sakit Hassan Sadikin</option>
                        <option value=3>Rumah Sakit Persahabatan</option>
                        <option value=4>Rumah Sakit Permata Depok</option>
                    </select>
                </div>
                <div class="form-group">
                    <p>Jenis Dokter</p>
                    <input type="radio" id="du" name="job" value="Dokter Umum">
                    <label for="du">Dokter Umum</label><br>
                    <input type="radio" id="dsa" name="job" value="Dokter Spesialis Anak">
                    <label for="dsa">Dokter Spesialis Anak</label><br>
                    <input type="radio" id="dsj" name="job" value="Dokter Spesialis Jantung">
                    <label for="dsj">Dokter Spesialis Jantung</label><br>
                    <input type="radio" id="dsk" name="job" value="Dokter Spesialis Kulit">
                    <label for="dsk">Dokter Spesialis Kulit</label><br>
                    <input type="radio" id="dske" name="job" value="Dokter Spesialis Kecantikan">
                    <label for="dske">Dokter Spesialis Kecantikan</label>
                </div>
                <div class="form-group">
                ...
                <p>Jenis Kelamin</>
                    ...
                    <div class="form-group"><button class="btn btn-primary btn-block" type="submit" style="background-color: rgb(0,167,157);">Daftar dokter</button></div><a class="already" href="<?= base_url("c_main"); ?>">Sudah punya akun? Masuk disini.</a>
            </form>
        </div>
    </div>

            ...
            <div class="row justify-content-center features" style="padding-bottom: 0px;">
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div class="box"><i class="fa fa-stethoscope icon" style="color: #00a79d;"></i>
                        ...
                        <p class="description">Dokter professional dari berbagai daerah Indonesia selalu siap untuk melakukan konsultasi dengan Anda.</p><a class="btn btn-primary" role="button" style="background-color: rgb(244,58,58);color: rgb(255,255,255);" href="<?= base_url('c_pasien/cdokter') ?>">Cari Dokter</a>
                    </div>
                </div>
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div class="box"><i class="fa fa-hospital-o icon" style="color: rgb(0,167,157);"></i>
                        <h3 class="name">Rumah Sakit</h3>
                        <p class="description">Ayosehat.com memiliki data rumah sakit di seluruh Indonesia. Cari rumah sakit di sekitar Anda sekarang.</p><a class="btn btn-primary" role="button" style="background-color: rgb(244,58,58);" href="<?= base_url('c_pasien/chospital') ?>">Cari rumah sakit</a>
                    </div>
                </div>
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div class="box"><i class="fas fa-briefcase-medical icon" style="color: rgb(0,167,157);"></i>
                        <h3 class="name">Obat</h3>
                        <p class="description">Ayosehat.com telah bekerja sama dengan berbagai perusahaan terkenal seperti Apotek K24 dan Kimia Farma</p><a class="btn btn-primary" role="button" style="background-color: rgb(244,58,58);color: rgb(255,255,255);" href="<?= base_url('c_pasien/capotek') ?>">Cari Apotek</a>
                    </div>
                </div>
            </div>
        </div>

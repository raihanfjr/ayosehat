<body id="page-top" style="background-color: #00cfc2;">
    ...
    <div data-aos="fade" class="simple-slider">
        <div class="swiper-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide" style="background-image: url(<?= base_url('') ?>assets/img/3.jpg);background-position: center;margin-top: 55px;">
                ...
                <div class="swiper-slide" style="background-image: url(<?= base_url('') ?>assets/img/obat.jpg);background-position: center;margin-top: 55px;">
                    <div class="box" style="margin: 123px;margin-top: 150px;margin-right: 150px;margin-left: 150px;background-color: rgba(0,167,157,0.57);padding-top: 10px;padding-right: 10px;padding-bottom: 10px;padding-left: 10px;border-radius: 10px;max-width: 470px;min-width: 200px;max-height: 187px;min-height: 187px;text-align: center;">
                        <h3 class="name" style="color: rgb(255,255,255);"><strong>AYO&nbsp;</strong><i class="fa fa-heartbeat"></i><strong>&nbsp;SEHAT</strong></h3>
            ...
            <div class="row justify-content-center features" style="padding-bottom: 0px;">
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div class="box"><i class="fa fa-stethoscope icon" style="color: #00a79d;"></i>
                        ...
                        <p class="description">Dokter professional dari berbagai daerah Indonesia selalu siap untuk melakukan konsultasi dengan Anda.</p><a class="btn btn-primary" role="button" style="background-color: rgb(244,58,58);" href="<?= base_url('') ?>">Cari Dokter</a>
                    </div>
                </div>
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div class="box"><i class="fa fa-hospital-o icon" style="color: rgb(0,167,157);"></i>
                        <h3 class="name">Rumah Sakit</h3>
                        <p class="description">Ayosehat.com memiliki data rumah sakit di seluruh Indonesia. Cari rumah sakit di sekitar Anda sekarang.</p><a class="btn btn-primary" role="button" style="background-color: rgb(244,58,58);" href="<?= base_url('') ?>">Cari rumah sakit</a>
                    </div>
                </div>
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div class="box"><i class="fas fa-briefcase-medical icon" style="color: rgb(0,167,157);"></i>
                        <h3 class="name">Obat</h3>
                        <p class="description">Ayosehat.com telah bekerja sama dengan berbagai perusahaan terkenal seperti Apotek K24 dan Kimia Farma</p><a class="btn btn-primary" role="button" style="background-color: rgb(244,58,58);" href="<?= base_url('') ?>">Cari Apotek</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row people" style="padding-top: 40px;padding-bottom: 0px;">
                <div class="col-md-6 col-lg-4 item">
                    <div class="box"><img src="<?= base_url('') ?>assets/img/dokter1.png" style="max-width: 160px;max-height: 230px;">
                ...
                <div class="col-md-6 col-lg-4 item">
                    <div class="box"><img src="<?= base_url('') ?>assets/img/dokter3.jpg" style="max-width: 160px;max-height: 230px;">
                ...
                <div class="col-md-6 col-lg-4 item">
                    <div class="box"><img src="<?= base_url('') ?>assets/img/dokter2.jpg" style="max-height: 230px;">
